...
class AlienInvasion:
    ...
    def _check_events(self):
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                self._check_events_keydown_events_(event)
            elif event.type == pygame.KEYUP:
                self._check_events_keyup_events_(event)
            elif event.type == pygame.MOUSEBUTTONDOWN:
                mouse_pos = pygame.mouse.get_pos()
                self._check_play_button(mouse_pos)
    
    def _check_events_keydown_events_(self, event):
    ...
    def _check_events_keyup_events_(self, event):
        if event.key == pygame.K_RIGHT:
    ...
    def _create_alien(self, x_position, y_position):
        ...
        print(f"Alien created at ({x_position}, {y_position})")
